...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('vendor/unisharp/laravel-filemanager/public/css/mfb.css') }}">
  <link rel="stylesheet" href="{{ asset('vendor/unisharp/laravel-filemanager/public/css/dropzone.min.css') }}">
...
<body>
  ...
  <div id="lfm-loader">
    <img src="{{ asset('vendor/unisharp/laravel-filemanager/public/img/loader.svg') }}">
  </div>
  ...
  <script src="{{ asset('vendor/unisharp/laravel-filemanager/public/js/jquery.form.min.js') }}"></script>
